...
when defined(thorvgSceneEffects):
  ...
  proc tvg_scene_push_gaussian_blur*(scene: ptr Tvg_Paint; sigma: cfloat;
                                    direction: cint; border: cint; quality: cint): Tvg_Result {.
      importc: "tvg_scene_push_gaussian_blur", dynlib: thorvgLibName.}
    ##
                                ##
  ...
  proc tvg_scene_push_fill*(scene: ptr Tvg_Paint; r: cint; g: cint; b: cint;
                            a: cint): Tvg_Result {.importc: "tvg_scene_push_fill",
      dynlib: thorvgLibName.}
    ##
  ...
  proc tvg_scene_push_tint*(scene: ptr Tvg_Paint; black_r: cint; black_g: cint;
                            black_b: cint; white_r: cint; white_g: cint;
                            white_b: cint; intensity: cfloat): Tvg_Result {.
      importc: "tvg_scene_push_tint", dynlib: thorvgLibName.}
    ##
                                ##
  ...
  proc tvg_scene_push_tritone*(scene: ptr Tvg_Paint; shadow_r: cint;
                              shadow_g: cint; shadow_b: cint; midtone_r: cint;
                              midtone_g: cint; midtone_b: cint;
                              highlight_r: cint; highlight_g: cint;
                              highlight_b: cint): Tvg_Result {.
      importc: "tvg_scene_push_tritone", dynlib: thorvgLibName.}
    ##
                                ##
