...
when defined(windows):
  const thorvg = "thorvg.dll"
elif defined(macosx):
  const thorvg = "libthorvg.dylib"
else:
  const thorvg = "libthorvg.so"

type
  # Opaque pointer types
  TvgCanvas* {.importc: "Tvg_Canvas", header: hdr.} = object
  TvgPaint* {.importc: "Tvg_Paint", header: hdr.} = object
  TvgGradient* {.importc: "Tvg_Gradient", header: hdr.} = object
  TvgSaver* {.importc: "Tvg_Saver", header: hdr.} = object
  TvgAnimation* {.importc: "Tvg_Animation", header: hdr.} = object
  TvgAccessor* {.importc: "Tvg_Accessor", header: hdr.} = object
...
type
  Tvg_Color_Stop* {.importc: "Tvg_Color_Stop", header: "thorvg_capi_example.h",
                    bycopy.} = object ##  \}
                                       ...
                                       ##
    offset* {.importc: "offset".}: cfloat ## < The relative position of the color.
    r* {.importc: "r".}: uint8 ## < The red color channel value in the range [0 ~ 255].
    g* {.importc: "g".}: uint8 ## < The green color channel value in the range [0 ~ 255].
    b* {.importc: "b".}: uint8 ## < The blue color channel value in the range [0 ~ 255].
    a* {.importc: "a".}: uint8
    ## < The alpha channel value in the range [0 ~ 255], where 0 is completely transparent and 255 is opaque.

  Tvg_Point* {.importc: "Tvg_Point", header: "thorvg_capi_example.h", bycopy.} = object ##  \}
  ...
  Tvg_Matrix* {.importc: "Tvg_Matrix", header: "thorvg_capi_example.h", bycopy.} = object ##
                                                                                           ...
                                                                                           ##
    e11* {.importc: "e11".}: cfloat
    e12* {.importc: "e12".}: cfloat
    e13* {.importc: "e13".}: cfloat
    e21* {.importc: "e21".}: cfloat
    e22* {.importc: "e22".}: cfloat
    e23* {.importc: "e23".}: cfloat
    e31* {.importc: "e31".}: cfloat
    e32* {.importc: "e32".}: cfloat
    e33* {.importc: "e33".}: cfloat


proc tvg_engine_init*(threads: cuint): Tvg_Result {.cdecl,
    importc: "tvg_engine_init", dynlib: thorvg.}
  ##
                                                ...
                                                ##  @see tvg_engine_term()
                                                ##
proc tvg_engine_term*(): Tvg_Result {.cdecl, importc: "tvg_engine_term",
                                      dynlib: thorvg.}
  ## !
...
proc tvg_engine_version*(major: ptr uint32; minor: ptr uint32;
  ...
  ##
                                                          ...
                                                          ##  @since 0.15
                                                          ##
proc tvg_swcanvas_create*(): ptr Tvg_Canvas {.cdecl,
    importc: "tvg_swcanvas_create", dynlib: thorvg.}
  ##  \}
...
proc tvg_swcanvas_set_target*(canvas: ptr Tvg_Canvas; buffer: ptr uint32;
                              ...
                              cs: Tvg_Colorspace): Tvg_Result {.cdecl,
    importc: "tvg_swcanvas_set_target", dynlib: thorvg.}
  ## !
                                                        ...
                                                        ##  @see Tvg_Colorspace
                                                        ##
proc tvg_glcanvas_create*(): ptr Tvg_Canvas {.cdecl,
    importc: "tvg_glcanvas_create", dynlib: thorvg.}
  ##  \}
...
proc tvg_glcanvas_set_target*(canvas: ptr Tvg_Canvas; context: pointer;
                              ...
                              cs: Tvg_Colorspace): Tvg_Result {.cdecl,
    importc: "tvg_glcanvas_set_target", dynlib: thorvg.}
  ## !
                                                        ...
                                                        ##
proc tvg_wgcanvas_create*(): ptr Tvg_Canvas {.cdecl,
    importc: "tvg_wgcanvas_create", dynlib: thorvg.}
  ##  \}
...
proc tvg_wgcanvas_set_target*(canvas: ptr Tvg_Canvas; device: pointer;
    ...
    cdecl, importc: "tvg_wgcanvas_set_target", dynlib: thorvg.}
  ## !
                                                               ...
                                                               ##  @note Experimental API
                                                               ##
proc tvg_canvas_destroy*(canvas: ptr Tvg_Canvas): Tvg_Result {.cdecl,
    importc: "tvg_canvas_destroy", dynlib: thorvg.}
  ##  \}
...
proc tvg_canvas_push*(canvas: ptr Tvg_Canvas; paint: ptr Tvg_Paint): Tvg_Result {.
    cdecl, importc: "tvg_canvas_push", dynlib: thorvg.}
  ## !
...
proc tvg_canvas_push_at*(canvas: ptr Tvg_Canvas; target: ptr Tvg_Paint;
                         at: ptr Tvg_Paint): Tvg_Result {.cdecl,
    importc: "tvg_canvas_push_at", dynlib: thorvg.}
  ##
...
proc tvg_canvas_remove*(canvas: ptr Tvg_Canvas; paint: ptr Tvg_Paint): Tvg_Result {.
    cdecl, importc: "tvg_canvas_remove", dynlib: thorvg.}
  ##
                                                         ...
                                                         ##  @since 1.0
                                                         ##
proc tvg_canvas_update*(canvas: ptr Tvg_Canvas): Tvg_Result {.cdecl,
    importc: "tvg_canvas_update", dynlib: thorvg.}
  ## !
...
proc tvg_canvas_update_paint*(canvas: ptr Tvg_Canvas; paint: ptr Tvg_Paint): Tvg_Result {.
    cdecl, importc: "tvg_canvas_update_paint", dynlib: thorvg.}
  ## !
                                                               ...
                                                               ##
proc tvg_canvas_draw*(canvas: ptr Tvg_Canvas; clear: bool): Tvg_Result {.cdecl,
    importc: "tvg_canvas_draw", dynlib: thorvg.}
  ## !
                                                ...
                                                ##  @see tvg_canvas_sync()
                                                ##
proc tvg_canvas_sync*(canvas: ptr Tvg_Canvas): Tvg_Result {.cdecl,
    importc: "tvg_canvas_sync", dynlib: thorvg.}
  ## !
...
proc tvg_canvas_set_viewport*(canvas: ptr Tvg_Canvas; x: int32; y: int32;
                              w: int32; h: int32): Tvg_Result {.cdecl,
    importc: "tvg_canvas_set_viewport", dynlib: thorvg.}
  ## !
                                                        ...
                                                        ##  @since 0.15
                                                        ##
proc tvg_paint_del*(paint: ptr Tvg_Paint): Tvg_Result {.cdecl,
    importc: "tvg_paint_del", dynlib: thorvg.}
  ##  \}
                                              ...
                                              ##  @see tvg_canvas_remove()
                                              ##
proc tvg_paint_ref*(paint: ptr Tvg_Paint): uint8 {.cdecl,
    importc: "tvg_paint_ref", dynlib: thorvg.}
  ##
                                              ...
                                              ##  @since 1.0
                                              ##
proc tvg_paint_unref*(paint: ptr Tvg_Paint; free: bool): uint8 {.cdecl,
    importc: "tvg_paint_unref", dynlib: thorvg.}
  ##
                                                ...
                                                ##  @since 1.0
                                                ##
proc tvg_paint_get_ref*(paint: ptr Tvg_Paint): uint8 {.cdecl,
    importc: "tvg_paint_get_ref", dynlib: thorvg.}
  ##
                                                  ...
                                                  ##  @since 1.0
                                                  ##
proc tvg_paint_scale*(paint: ptr Tvg_Paint; factor: cfloat): Tvg_Result {.cdecl,
    importc: "tvg_paint_scale", dynlib: thorvg.}
  ## !
...
proc tvg_paint_rotate*(paint: ptr Tvg_Paint; degree: cfloat): Tvg_Result {.
    cdecl, importc: "tvg_paint_rotate", dynlib: thorvg.}
  ## !
...
proc tvg_paint_translate*(paint: ptr Tvg_Paint; x: cfloat; y: cfloat): Tvg_Result {.
    cdecl, importc: "tvg_paint_translate", dynlib: thorvg.}
  ## !
...
proc tvg_paint_set_transform*(paint: ptr Tvg_Paint; m: ptr Tvg_Matrix): Tvg_Result {.
    cdecl, importc: "tvg_paint_set_transform", dynlib: thorvg.}
  ## !
...
proc tvg_paint_get_transform*(paint: ptr Tvg_Paint; m: ptr Tvg_Matrix): Tvg_Result {.
    cdecl, importc: "tvg_paint_get_transform", dynlib: thorvg.}
  ## !
...
proc tvg_paint_set_opacity*(paint: ptr Tvg_Paint; opacity: uint8): Tvg_Result {.
    cdecl, importc: "tvg_paint_set_opacity", dynlib: thorvg.}
  ## !
...
proc tvg_paint_get_opacity*(paint: ptr Tvg_Paint; opacity: ptr uint8): Tvg_Result {.
    cdecl, importc: "tvg_paint_get_opacity", dynlib: thorvg.}
  ## !
                                                             ...
                                                             ##  @retval TVG_RESULT_INVALID_ARGUMENT In case a @c nullptr is passed as the argument.
                                                             ##
proc tvg_paint_duplicate*(paint: ptr Tvg_Paint): ptr Tvg_Paint {.cdecl,
    importc: "tvg_paint_duplicate", dynlib: thorvg.}
  ## !
...
proc tvg_paint_get_aabb*(paint: ptr Tvg_Paint; x: ptr cfloat; y: ptr cfloat;
                         w: ptr cfloat; h: ptr cfloat): Tvg_Result {.cdecl,
    importc: "tvg_paint_get_aabb", dynlib: thorvg.}
  ##
...
proc tvg_paint_get_obb*(paint: ptr Tvg_Paint; pt4: ptr Tvg_Point): Tvg_Result {.
    cdecl, importc: "tvg_paint_get_obb", dynlib: thorvg.}
  ##
...
proc tvg_paint_set_mask_method*(paint: ptr Tvg_Paint; target: ptr Tvg_Paint;
                                `method`: Tvg_Mask_Method): Tvg_Result {.cdecl,
    importc: "tvg_paint_set_mask_method", dynlib: thorvg.}
  ## !
...
proc tvg_paint_get_mask_method*(paint: ptr Tvg_Paint; target: ptr ptr Tvg_Paint;
    ...
    cdecl, importc: "tvg_paint_get_mask_method", dynlib: thorvg.}
  ##
...
proc tvg_paint_clip*(paint: ptr Tvg_Paint; clipper: ptr Tvg_Paint): Tvg_Result {.
    cdecl, importc: "tvg_paint_clip", dynlib: thorvg.}
  ## !
                                                      ...
                                                      ##  @since 1.0
                                                      ##
proc tvg_paint_get_parent*(paint: ptr Tvg_Paint): ptr Tvg_Paint {.cdecl,
    importc: "tvg_paint_get_parent", dynlib: thorvg.}
  ##
...
proc tvg_paint_get_type*(paint: ptr Tvg_Paint; `type`: ptr Tvg_Type): Tvg_Result {.
    cdecl, importc: "tvg_paint_get_type", dynlib: thorvg.}
  ##
...
proc tvg_paint_set_blend_method*(paint: ptr Tvg_Paint;
    ...
    cdecl, importc: "tvg_paint_set_blend_method", dynlib: thorvg.}
  ##
                                                                  ...
                                                                  ##  @since 0.15
                                                                  ##
proc tvg_shape_new*(): ptr Tvg_Paint {.cdecl, importc: "tvg_shape_new",
                                       dynlib: thorvg.}
  ##  \}
                                                       ...
                                                       ##
proc tvg_shape_reset*(paint: ptr Tvg_Paint): Tvg_Result {.cdecl,
    importc: "tvg_shape_reset", dynlib: thorvg.}
  ## !
...
proc tvg_shape_move_to*(paint: ptr Tvg_Paint; x: cfloat; y: cfloat): Tvg_Result {.
    cdecl, importc: "tvg_shape_move_to", dynlib: thorvg.}
  ## !
...
proc tvg_shape_line_to*(paint: ptr Tvg_Paint; x: cfloat; y: cfloat): Tvg_Result {.
    cdecl, importc: "tvg_shape_line_to", dynlib: thorvg.}
  ## !
...
proc tvg_shape_cubic_to*(paint: ptr Tvg_Paint; cx1: cfloat; cy1: cfloat;
    ...
    cdecl, importc: "tvg_shape_cubic_to", dynlib: thorvg.}
  ## !
                                                          ...
                                                          ##
proc tvg_shape_close*(paint: ptr Tvg_Paint): Tvg_Result {.cdecl,
    importc: "tvg_shape_close", dynlib: thorvg.}
  ## !
...
proc tvg_shape_append_rect*(paint: ptr Tvg_Paint; x: cfloat; y: cfloat;
                            ...
                            cw: bool): Tvg_Result {.cdecl,
    importc: "tvg_shape_append_rect", dynlib: thorvg.}
  ## !
...
proc tvg_shape_append_circle*(paint: ptr Tvg_Paint; cx: cfloat; cy: cfloat;
    ...
    cdecl, importc: "tvg_shape_append_circle", dynlib: thorvg.}
  ## !
...
proc tvg_shape_append_path*(paint: ptr Tvg_Paint; cmds: ptr Tvg_Path_Command;
    ...
    cdecl, importc: "tvg_shape_append_path", dynlib: thorvg.}
  ## !
...
proc tvg_shape_get_path*(paint: ptr Tvg_Paint; cmds: ptr ptr Tvg_Path_Command;
                         ...
                         ptsCnt: ptr uint32): Tvg_Result {.cdecl,
    importc: "tvg_shape_get_path", dynlib: thorvg.}
  ## !
...
proc tvg_shape_set_stroke_width*(paint: ptr Tvg_Paint; width: cfloat): Tvg_Result {.
    cdecl, importc: "tvg_shape_set_stroke_width", dynlib: thorvg.}
  ## !
...
proc tvg_shape_get_stroke_width*(paint: ptr Tvg_Paint; width: ptr cfloat): Tvg_Result {.
    cdecl, importc: "tvg_shape_get_stroke_width", dynlib: thorvg.}
  ## !
...
proc tvg_shape_set_stroke_color*(paint: ptr Tvg_Paint; r: uint8; g: uint8;
                                 b: uint8; a: uint8): Tvg_Result {.cdecl,
    importc: "tvg_shape_set_stroke_color", dynlib: thorvg.}
  ## !
...
proc tvg_shape_get_stroke_color*(paint: ptr Tvg_Paint; r: ptr uint8;
    ...
    cdecl, importc: "tvg_shape_get_stroke_color", dynlib: thorvg.}
  ## !
...
proc tvg_shape_set_stroke_gradient*(paint: ptr Tvg_Paint; grad: ptr Tvg_Gradient): Tvg_Result {.
    cdecl, importc: "tvg_shape_set_stroke_gradient", dynlib: thorvg.}
  ## !
...
proc tvg_shape_get_stroke_gradient*(paint: ptr Tvg_Paint;
    ...
    cdecl, importc: "tvg_shape_get_stroke_gradient", dynlib: thorvg.}
  ## !
...
proc tvg_shape_set_stroke_dash*(paint: ptr Tvg_Paint; dashPattern: ptr cfloat;
    ...
    cdecl, importc: "tvg_shape_set_stroke_dash", dynlib: thorvg.}
  ## !
...
proc tvg_shape_get_stroke_dash*(paint: ptr Tvg_Paint;
                                ...
                                offset: ptr cfloat): Tvg_Result {.cdecl,
    importc: "tvg_shape_get_stroke_dash", dynlib: thorvg.}
  ## !
...
proc tvg_shape_set_stroke_cap*(paint: ptr Tvg_Paint; cap: Tvg_Stroke_Cap): Tvg_Result {.
    cdecl, importc: "tvg_shape_set_stroke_cap", dynlib: thorvg.}
  ## !
...
proc tvg_shape_get_stroke_cap*(paint: ptr Tvg_Paint; cap: ptr Tvg_Stroke_Cap): Tvg_Result {.
    cdecl, importc: "tvg_shape_get_stroke_cap", dynlib: thorvg.}
  ## !
...
proc tvg_shape_set_stroke_join*(paint: ptr Tvg_Paint; join: Tvg_Stroke_Join): Tvg_Result {.
    cdecl, importc: "tvg_shape_set_stroke_join", dynlib: thorvg.}
  ## !
...
proc tvg_shape_get_stroke_join*(paint: ptr Tvg_Paint; join: ptr Tvg_Stroke_Join): Tvg_Result {.
    cdecl, importc: "tvg_shape_get_stroke_join", dynlib: thorvg.}
  ## !
...
proc tvg_shape_set_stroke_miterlimit*(paint: ptr Tvg_Paint; miterlimit: cfloat): Tvg_Result {.
    cdecl, importc: "tvg_shape_set_stroke_miterlimit", dynlib: thorvg.}
  ## !
...
proc tvg_shape_get_stroke_miterlimit*(paint: ptr Tvg_Paint;
    ...
    cdecl, importc: "tvg_shape_get_stroke_miterlimit", dynlib: thorvg.}
  ## !
...
proc tvg_shape_set_trimpath*(paint: ptr Tvg_Paint; begin: cfloat; `end`: cfloat;
                             simultaneous: bool): Tvg_Result {.cdecl,
    importc: "tvg_shape_set_trimpath", dynlib: thorvg.}
  ## !
...
proc tvg_shape_set_fill_color*(paint: ptr Tvg_Paint; r: uint8; g: uint8;
                               b: uint8; a: uint8): Tvg_Result {.cdecl,
    importc: "tvg_shape_set_fill_color", dynlib: thorvg.}
  ## !
...
proc tvg_shape_get_fill_color*(paint: ptr Tvg_Paint; r: ptr uint8; g: ptr uint8;
                               b: ptr uint8; a: ptr uint8): Tvg_Result {.cdecl,
    importc: "tvg_shape_get_fill_color", dynlib: thorvg.}
  ## !
...
proc tvg_shape_set_fill_rule*(paint: ptr Tvg_Paint; rule: Tvg_Fill_Rule): Tvg_Result {.
    cdecl, importc: "tvg_shape_set_fill_rule", dynlib: thorvg.}
  ## !
...
proc tvg_shape_get_fill_rule*(paint: ptr Tvg_Paint; rule: ptr Tvg_Fill_Rule): Tvg_Result {.
    cdecl, importc: "tvg_shape_get_fill_rule", dynlib: thorvg.}
  ## !
...
proc tvg_shape_set_paint_order*(paint: ptr Tvg_Paint; strokeFirst: bool): Tvg_Result {.
    cdecl, importc: "tvg_shape_set_paint_order", dynlib: thorvg.}
  ## !
...
proc tvg_shape_set_gradient*(paint: ptr Tvg_Paint; grad: ptr Tvg_Gradient): Tvg_Result {.
    cdecl, importc: "tvg_shape_set_gradient", dynlib: thorvg.}
  ## !
...
proc tvg_shape_get_gradient*(paint: ptr Tvg_Paint; grad: ptr ptr Tvg_Gradient): Tvg_Result {.
    cdecl, importc: "tvg_shape_get_gradient", dynlib: thorvg.}
  ## !
                                                              ...
                                                              ##  @retval TVG_RESULT_INVALID_ARGUMENT An invalid pointer passed as an argument.
                                                              ##
proc tvg_linear_gradient_new*(): ptr Tvg_Gradient {.cdecl,
    importc: "tvg_linear_gradient_new", dynlib: thorvg.}
  ##  \}
                                                        ...
                                                        ##
proc tvg_radial_gradient_new*(): ptr Tvg_Gradient {.cdecl,
    importc: "tvg_radial_gradient_new", dynlib: thorvg.}
  ## !
...
proc tvg_linear_gradient_set*(grad: ptr Tvg_Gradient; x1: cfloat; y1: cfloat;
                              x2: cfloat; y2: cfloat): Tvg_Result {.cdecl,
    importc: "tvg_linear_gradient_set", dynlib: thorvg.}
  ## !
...
proc tvg_linear_gradient_get*(grad: ptr Tvg_Gradient; x1: ptr cfloat;
    ...
    cdecl, importc: "tvg_linear_gradient_get", dynlib: thorvg.}
  ## !
...
proc tvg_radial_gradient_set*(grad: ptr Tvg_Gradient; cx: cfloat; cy: cfloat;
    ...
    cdecl, importc: "tvg_radial_gradient_set", dynlib: thorvg.}
  ## !
...
proc tvg_radial_gradient_get*(grad: ptr Tvg_Gradient; cx: ptr cfloat;
    ...
    cdecl, importc: "tvg_radial_gradient_get", dynlib: thorvg.}
  ## !
...
proc tvg_gradient_set_color_stops*(grad: ptr Tvg_Gradient;
    ...
    cdecl, importc: "tvg_gradient_set_color_stops", dynlib: thorvg.}
  ## !
...
proc tvg_gradient_get_color_stops*(grad: ptr Tvg_Gradient;
                                   ...
                                   cnt: ptr uint32): Tvg_Result {.cdecl,
    importc: "tvg_gradient_get_color_stops", dynlib: thorvg.}
  ## !
...
proc tvg_gradient_set_spread*(grad: ptr Tvg_Gradient; spread: Tvg_Stroke_Fill): Tvg_Result {.
    cdecl, importc: "tvg_gradient_set_spread", dynlib: thorvg.}
  ## !
...
proc tvg_gradient_get_spread*(grad: ptr Tvg_Gradient;
                              spread: ptr Tvg_Stroke_Fill): Tvg_Result {.cdecl,
    importc: "tvg_gradient_get_spread", dynlib: thorvg.}
  ## !
...
proc tvg_gradient_set_transform*(grad: ptr Tvg_Gradient; m: ptr Tvg_Matrix): Tvg_Result {.
    cdecl, importc: "tvg_gradient_set_transform", dynlib: thorvg.}
  ## !
...
proc tvg_gradient_get_transform*(grad: ptr Tvg_Gradient; m: ptr Tvg_Matrix): Tvg_Result {.
    cdecl, importc: "tvg_gradient_get_transform", dynlib: thorvg.}
  ## !
...
proc tvg_gradient_get_type*(grad: ptr Tvg_Gradient; `type`: ptr Tvg_Type): Tvg_Result {.
    cdecl, importc: "tvg_gradient_get_type", dynlib: thorvg.}
  ##
                                                             ...
                                                             ##  @since 1.0
                                                             ##
proc tvg_gradient_duplicate*(grad: ptr Tvg_Gradient): ptr Tvg_Gradient {.cdecl,
    importc: "tvg_gradient_duplicate", dynlib: thorvg.}
  ## !
                                                       ...
                                                       ##
proc tvg_gradient_del*(grad: ptr Tvg_Gradient): Tvg_Result {.cdecl,
    importc: "tvg_gradient_del", dynlib: thorvg.}
  ## !
                                                 ...
                                                 ##  @retval TVG_RESULT_INVALID_ARGUMENT An invalid Tvg_Gradient pointer.
                                                 ##
proc tvg_picture_new*(): ptr Tvg_Paint {.cdecl, importc: "tvg_picture_new",
    dynlib: thorvg.}
  ##  \}
                    ...
                    ##
proc tvg_picture_load*(paint: ptr Tvg_Paint; path: cstring): Tvg_Result {.cdecl,
    importc: "tvg_picture_load", dynlib: thorvg.}
  ## !
...
proc tvg_picture_load_raw*(paint: ptr Tvg_Paint; data: ptr uint32; w: uint32;
    ...
    cdecl, importc: "tvg_picture_load_raw", dynlib: thorvg.}
  ## !
...
proc tvg_picture_load_data*(paint: ptr Tvg_Paint; data: cstring; size: uint32;
    ...
    cdecl, importc: "tvg_picture_load_data", dynlib: thorvg.}
  ## !
...
proc tvg_picture_set_size*(paint: ptr Tvg_Paint; w: cfloat; h: cfloat): Tvg_Result {.
    cdecl, importc: "tvg_picture_set_size", dynlib: thorvg.}
  ## !
...
proc tvg_picture_get_size*(paint: ptr Tvg_Paint; w: ptr cfloat; h: ptr cfloat): Tvg_Result {.
    cdecl, importc: "tvg_picture_get_size", dynlib: thorvg.}
  ## !
...
proc tvg_picture_get_paint*(paint: ptr Tvg_Paint; id: uint32): ptr Tvg_Paint {.
    cdecl, importc: "tvg_picture_get_paint", dynlib: thorvg.}
  ## !
                                                             ...
                                                             ##  @note Experimental API
                                                             ##
proc tvg_scene_new*(): ptr Tvg_Paint {.cdecl, importc: "tvg_scene_new",
                                       dynlib: thorvg.}
  ##  \}
...
proc tvg_scene_push*(scene: ptr Tvg_Paint; paint: ptr Tvg_Paint): Tvg_Result {.
    cdecl, importc: "tvg_scene_push", dynlib: thorvg.}
  ##
...
proc tvg_scene_push_at*(scene: ptr Tvg_Paint; target: ptr Tvg_Paint;
                        at: ptr Tvg_Paint): Tvg_Result {.cdecl,
    importc: "tvg_scene_push_at", dynlib: thorvg.}
  ##
                                                  ##  @brief Adds a paint object to the scene.
                                                  ##
...
proc tvg_scene_remove*(scene: ptr Tvg_Paint; paint: ptr Tvg_Paint): Tvg_Result {.
    cdecl, importc: "tvg_scene_remove", dynlib: thorvg.}
  ##
                                                        ...
                                                        ##  @since 1.0
                                                        ##
proc tvg_text_new*(): ptr Tvg_Paint {.cdecl, importc: "tvg_text_new",
                                      dynlib: thorvg.}
  ##  \}
...
proc tvg_text_set_font*(paint: ptr Tvg_Paint; name: cstring; size: cfloat;
                        style: cstring): Tvg_Result {.cdecl,
    importc: "tvg_text_set_font", dynlib: thorvg.}
  ##
...
proc tvg_text_set_text*(paint: ptr Tvg_Paint; text: cstring): Tvg_Result {.
    cdecl, importc: "tvg_text_set_text", dynlib: thorvg.}
  ##
...
proc tvg_text_set_fill_color*(paint: ptr Tvg_Paint; r: uint8; g: uint8; b: uint8): Tvg_Result {.
    cdecl, importc: "tvg_text_set_fill_color", dynlib: thorvg.}
  ##
...
proc tvg_text_set_gradient*(paint: ptr Tvg_Paint; gradient: ptr Tvg_Gradient): Tvg_Result {.
    cdecl, importc: "tvg_text_set_gradient", dynlib: thorvg.}
  ##
                                                             ...
                                                             ##  @since 0.15
                                                             ##
proc tvg_font_load*(path: cstring): Tvg_Result {.cdecl,
    importc: "tvg_font_load", dynlib: thorvg.}
  ##
...
proc tvg_font_load_data*(name: cstring; data: cstring; size: uint32;
                         mimetype: cstring; copy: bool): Tvg_Result {.cdecl,
    importc: "tvg_font_load_data", dynlib: thorvg.}
  ##
                                                   ...
                                                   ##  @since 0.15
                                                   ##
proc tvg_font_unload*(path: cstring): Tvg_Result {.cdecl,
    importc: "tvg_font_unload", dynlib: thorvg.}
  ##
                                                ...
                                                ##  @since 0.15
                                                ##
proc tvg_saver_new*(): ptr Tvg_Saver {.cdecl, importc: "tvg_saver_new",
                                       dynlib: thorvg.}
  ##  \}
...
proc tvg_saver_save*(saver: ptr Tvg_Saver; paint: ptr Tvg_Paint; path: cstring;
                     quality: uint32): Tvg_Result {.cdecl,
    importc: "tvg_saver_save", dynlib: thorvg.}
  ## !
                                               ...
                                               ##  @see tvg_saver_sync()
                                               ##
proc tvg_saver_sync*(saver: ptr Tvg_Saver): Tvg_Result {.cdecl,
    importc: "tvg_saver_sync", dynlib: thorvg.}
  ## !
                                               ...
                                               ##  @see tvg_saver_save()
                                               ##
proc tvg_saver_del*(saver: ptr Tvg_Saver): Tvg_Result {.cdecl,
    importc: "tvg_saver_del", dynlib: thorvg.}
  ## !
                                              ...
                                              ##
proc tvg_animation_new*(): ptr Tvg_Animation {.cdecl,
    importc: "tvg_animation_new", dynlib: thorvg.}
  ##  \}
...
proc tvg_animation_set_frame*(animation: ptr Tvg_Animation; no: cfloat): Tvg_Result {.
    cdecl, importc: "tvg_animation_set_frame", dynlib: thorvg.}
  ## !
...
proc tvg_animation_get_picture*(animation: ptr Tvg_Animation): ptr Tvg_Paint {.
    cdecl, importc: "tvg_animation_get_picture", dynlib: thorvg.}
  ## !
...
proc tvg_animation_get_frame*(animation: ptr Tvg_Animation; no: ptr cfloat): Tvg_Result {.
    cdecl, importc: "tvg_animation_get_frame", dynlib: thorvg.}
  ## !
...
proc tvg_animation_get_total_frame*(animation: ptr Tvg_Animation;
                                    cnt: ptr cfloat): Tvg_Result {.cdecl,
    importc: "tvg_animation_get_total_frame", dynlib: thorvg.}
  ## !
...
proc tvg_animation_get_duration*(animation: ptr Tvg_Animation;
                                 duration: ptr cfloat): Tvg_Result {.cdecl,
    importc: "tvg_animation_get_duration", dynlib: thorvg.}
  ## !
...
proc tvg_animation_set_segment*(animation: ptr Tvg_Animation; begin: cfloat;
                                `end`: cfloat): Tvg_Result {.cdecl,
    importc: "tvg_animation_set_segment", dynlib: thorvg.}
  ## !
...
proc tvg_animation_get_segment*(animation: ptr Tvg_Animation; begin: ptr cfloat;
                                `end`: ptr cfloat): Tvg_Result {.cdecl,
    importc: "tvg_animation_get_segment", dynlib: thorvg.}
  ## !
                                                          ...
                                                          ##  @since 1.0
                                                          ##
proc tvg_animation_del*(animation: ptr Tvg_Animation): Tvg_Result {.cdecl,
    importc: "tvg_animation_del", dynlib: thorvg.}
  ## !
                                                  ...
                                                  ##  @since 0.13
                                                  ##
proc tvg_accessor_new*(): ptr Tvg_Accessor {.cdecl, importc: "tvg_accessor_new",
    dynlib: thorvg.}
  ##  \}
                    ...
                    ##  @note Experimental API
                    ##
proc tvg_accessor_del*(accessor: ptr Tvg_Accessor): Tvg_Result {.cdecl,
    importc: "tvg_accessor_del", dynlib: thorvg.}
  ## !
...
proc tvg_accessor_set*(accessor: ptr Tvg_Accessor; paint: ptr Tvg_Paint; `func`: proc (
    paint: ptr Tvg_Paint; data: pointer): bool {.cdecl.}; data: pointer): Tvg_Result {.
    cdecl, importc: "tvg_accessor_set", dynlib: thorvg.}
  ## !
                                                        ...
                                                        ##  @note Experimental API
                                                        ##
proc tvg_accessor_generate_id*(name: cstring): uint32 {.cdecl,
    importc: "tvg_accessor_generate_id", dynlib: thorvg.}
  ## !
                                                         ...
                                                         ##  @note Experimental API
                                                         ##
proc tvg_lottie_animation_new*(): ptr Tvg_Animation {.cdecl,
    importc: "tvg_lottie_animation_new", dynlib: thorvg.}
  ##  \}
...
proc tvg_lottie_animation_override*(animation: ptr Tvg_Animation; slot: cstring): Tvg_Result {.
    cdecl, importc: "tvg_lottie_animation_override", dynlib: thorvg.}
  ## !
...
proc tvg_lottie_animation_set_marker*(animation: ptr Tvg_Animation;
                                      marker: cstring): Tvg_Result {.cdecl,
    importc: "tvg_lottie_animation_set_marker", dynlib: thorvg.}
  ## !
...
proc tvg_lottie_animation_get_markers_cnt*(animation: ptr Tvg_Animation;
    cnt: ptr uint32): Tvg_Result {.cdecl, importc: "tvg_lottie_animation_get_markers_cnt",
                                   dynlib: thorvg.}
  ## !
...
proc tvg_lottie_animation_get_marker*(animation: ptr Tvg_Animation; idx: uint32;
                                      name: cstringArray): Tvg_Result {.cdecl,
    importc: "tvg_lottie_animation_get_marker", dynlib: thorvg.}
  ## !
...
proc tvg_lottie_animation_tween*(animation: ptr Tvg_Animation; `from`: cfloat;
    ...
    cdecl, importc: "tvg_lottie_animation_tween", dynlib: thorvg.}
  ##
...
proc tvg_lottie_animation_assign*(animation: ptr Tvg_Animation; layer: cstring;
                                  ix: uint32; varname: cstring; val: cfloat): Tvg_Result {.
    cdecl, importc: "tvg_lottie_animation_assign", dynlib: thorvg.}
  ## !
